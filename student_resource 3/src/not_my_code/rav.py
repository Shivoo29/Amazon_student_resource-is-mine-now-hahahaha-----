...
def process_images(image_folder, csv_file):
    column_names = ["image_name", "image number", "width", "depth", "height",
                    "item_weight", "maximum_weight_recommendation", "voltage",
                    "wattage", "item_volume"]
    ...
    for image_num, image_file in enumerate(os.listdir(image_folder), start=1):
        ...
        data_row["image_name"] = [image_file]  # Add image name to data_row
...
# Example usage
image_folder = '/home/codemaster29/Documents/Coding_Stuff/mlChallenge/AmazonML/66e31d6ee96cd_student_resource_3/student_resource 3/images/train'  # Replace with your folder path
csv_file = 'rav_result.csv'
